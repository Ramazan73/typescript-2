...
class Block {
    ...
    static calculateBlockHash =
        (id: number, previousHash: string, data: string, timestamp: number): string =>
...
const genesisBlock: Block = new Block(0, "23232323", "", "Hi there!", 888885);

let blockchain: [Block] = [genesisBlock]; // [Block] означает что только обьекты типа Блок могут храниться в переменной
